...
//         `${import.meta.env.VITE_API_BASE_URL || "http://localhost:5000"}/api/market/prices?${params.toString()}`,
//          {
//            headers: {
...
//       const token = localStorage.getItem("token");
//       const response = await fetch(
//         `${import.meta.env.VITE_API_BASE_URL || "http://localhost:5000"}/api/market/commodities`,
//         {
//           headers: {
//             'Authorization': token ? `Bearer ${token}` : '',
//             'Content-Type': 'application/json'
...
//         console.error("Authentication failed - please login again");
//       } else {
//         console.error("Failed to fetch commodities:", response.status);
//       }
//     } catch (error) {
...
//       const token = localStorage.getItem("token");
//       const response = await fetch(
//         `${import.meta.env.VITE_API_BASE_URL || "http://localhost:5000"}/api/market/trends?${params.toString()}`,
//         {
//           headers: {
//             'Authorization': token ? `Bearer ${token}` : '',
//             'Content-Type': 'application/json'
...
//                     <SelectItem key={index} value={commodity.toString()}>
//                       {commodity}
//                     </SelectItem>
//                   ))}
//               </SelectContent>
